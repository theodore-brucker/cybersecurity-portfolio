const blogPosts = [
    {
        ...
        content: `
        <h1>Discovering my path in cyber</h1>
    
        <h2>What did I do so far</h2>
        <p>
        ...
        <h2>What I am going to do next</h2>
        <p>
    ...
    Thinking like a manager, studying more on the topics I wasn't confident in, and leveraging my decade of exam taking experience were my strongest weapons.</p>
